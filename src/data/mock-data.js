...
const SCHEDULE_OVERVIEW = [
  { time: '08:45', label: '開場・代表者受付' },
  { time: '09:10', label: '審判ミーティング / コート確認' },
  { time: '09:30', label: '第1試合開始' },
  { time: '11:35', label: '午前終盤カード開始' },
  { time: '12:50', label: '午後カード開始' },
  { time: '14:30', label: '終盤カード開始' },
  { time: '14:55', label: '最終試合開始予定' },
  { time: '15:20', label: '集計・表彰準備' },
];
